...
import { Client, Salesperson, CajaTransaction, Product, ToastMessage, ConfirmationModalState, Venta } from './types';
...
import DailyCloseout from './components/DailyCloseout';
...
const ConfirmationModal: React.FC<ConfirmationModalProps> = ({ isOpen, onClose, onConfirm, title, message }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 dark:bg-opacity-80 flex items-center justify-center z-50 animate-fade-in-up" onClick={onClose}>
    ...
    switch (activeView) {
      case 'ventas':
        return <VentasManager 
                ...
                />;
      case 'clients':
        return <ClientManager clients={clients} setClients={setClients} ventas={ventas} setToast={setToast} showConfirmationModal={showConfirmationModal} />;
      case 'salespersons':
